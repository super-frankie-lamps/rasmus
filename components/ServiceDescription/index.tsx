...
Stiftelse af et A/S kræver, at du skal udfærdige vedtægter og et stiftelsesdokument. Derudover skal du have en oversigt over alle ejere i en ejerbog.
            ...
            <Box top="xxxl" className={styles.sideBar} left="xl" padding="xl" direction="column">
               ...
               <Box as="ul" top="xl" direction="column" className={styles.list}>
                  <AText as="li" size="l"><Link href="">Luk ApS</Link></AText>
                  <AText as="li" size="l"><Link href="">Luk A/S</Link></AText>
                  <AText as="li" size="l"><Link href="">Luk EMV</Link></AText>
                  <AText as="li" size="l"><Link href="">Luk I/S</Link></AText>
                  <AText as="li" size="l"><Link href="">Luk K/S</Link></AText>
               </Box>
            </Box>
         </Container>
      </Section>
