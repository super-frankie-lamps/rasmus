      ...
      <Section justify="center" className={styles.wrapper}>
         <Container>
            <Box direction="column">
               <AText as="h2" font="semiBold" size="xxl">Skal du til at stifte et aktieselskab (A/S) bør du bl.a. have styr på, hvad der er af krav til indskud.
Se, hvordan du opretter et aktieselskab, og hvor meget det koster.</AText>
               <Box>
                  <Box direction="column">
                     <AText as="h3" font="medium" size="l">Væsentligste kendetegn ved A/S</AText>
...
Det koster 670 kr. at registrere et A/S.</AText>
                     <AText as="h3" font="medium" size="l">Stiftelse og registrering af A/S</AText>
...
Registreringen af stiftelsen skal ske i Erhvervsstyrelsens IT-system inden 2 uger efter underskrivelsen af stiftelsesdokumentet. Ellers kan registrering ikke finde sted.
                     ...
                     <AText as="h3" font="medium" size="l">Indskud</AText>
...
En enkeltmandsvirksomhed kan eksempelvis indskydes som apportindskud ved stiftelsen af et A/S.
                     ...
                     <AText as="h3" font="medium" size="l">Krav til stiftere</AText>
